  ...
  Future<void> _handleSubmit() async {
    ...
    if (mounted) {
      ...
      if (result['success']) {
        ...
        _showError(result['message'] ?? 'Failed to create quotation');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Create New Quotation', style: TextStyle(fontWeight: FontWeight.w600)),
      ),
      body: _isLoading 
        ...
        Expanded(
          child: ElevatedButton(
            ...
            child: _isSubmitting 
              ...
              : const Text('Create Quotation', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          ),
        ),
      ],
    );
